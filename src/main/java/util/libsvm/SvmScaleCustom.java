...
public class SvmScaleCustom
{
	...
	private static void exit_with_help()
	{
		...
		+"options:\n"
		+"-o output_file: write output to output_file (if not specified writes in stdout)"
	...
	private void output_target(double value, BufferedWriter fpOut)throws IOException
	{
		if(y_scaling)
		{
			if(value == y_min)
	...
	private void output(int index, double value, BufferedWriter fpOut) throws IOException
	{
	...
	private void run(String []argv) throws IOException
	{
		...
		if (output_filename != null){
			try {
				fpOut = new BufferedWriter(new FileWriter(output_filename));
			} catch(IOException e) {
	...
	{
		SvmScaleCustom s = new SvmScaleCustom();
		s.run(argv);
	}
}
